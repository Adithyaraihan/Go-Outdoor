...
async function checkLoginStatus() {
  try {
    const response = await fetch("https://go-outdoor-e47n4qxfd-adithyas-projects-cf6d8ac5.vercel.app/auth/profile");
    if (response.ok) {
...
async function fetchProducts() {
  try {
    const response = await fetch("https://go-outdoor-e47n4qxfd-adithyas-projects-cf6d8ac5.vercel.app/api/products");
...
async function fetchCartItems() {
  ...
  try {
    const response = await fetch("https://go-outdoor-e47n4qxfd-adithyas-projects-cf6d8ac5.vercel.app/api/cart");
...
async function handleLogout(e) {
  e.preventDefault();
  try {
    await fetch("https://go-outdoor-e47n4qxfd-adithyas-projects-cf6d8ac5.vercel.app/auth/logout", { method: "POST" });
    AppState.currentUser = null;
    updateUIBasedOnLoginStatus();
...
async function handleAddToCart(e) {
  ...
  try {
    const response = await fetch("https://go-outdoor-e47n4qxfd-adithyas-projects-cf6d8ac5.vercel.app/api/cart/add", {
      method: "POST",
...
async function updateCartItemQuantity(cartId, newQuantity) {
  try {
    await fetch("https://go-outdoor-e47n4qxfd-adithyas-projects-cf6d8ac5.vercel.app/api/cart/update", {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
...
async function handleCheckout(e) {
  ...
  try {
    const response = await fetch("https://go-outdoor-e47n4qxfd-adithyas-projects-cf6d8ac5.vercel.app/api/process-order", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
